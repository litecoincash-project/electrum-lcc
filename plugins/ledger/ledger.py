...
from electrum_lcc.bitcoin import TYPE_ADDRESS, int_to_hex, var_int
...
from electrum_lcc.util import print_error, is_verbose, bfh, bh2u, versiontuple
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Litecoin Cash" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise BaseException(_("Device not in Litecoin Cash mode")) from e
                raise e
